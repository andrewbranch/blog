  ...
  return (
    <Layout>
      ...
      <p>
        ...
        at Microsoft, and since April 2019, the <a href="https://www.typescriptlang.org">
        TypeScript</a> language and compiler.
      </p>
      <p>
      ...
      <p>
        These days, I write a lot of TypeScript (go figure), and not long ago, a lot
        of <a href="https://reactjs.org">React</a>. (Now, my time with React is mostly spent
        just dreaming up bizarre and horrifying edge cases where it breaks our type system.)
        Aside from that, I try to spend my time doing things outside. One time I
        walked <a href="https://appalachiantrail.org">really far</a>, and I’ve
        ...
        film. I’ve also been trying to get better at <a href="https://www.instagram.com/p/Bv50vBFFXzd/">
        drawing</a> recently, although I don’t spend enough time on it. And very occasionally, I vastly
        underestimate the ambitiousness of a project like this blog and pour dozens of hours into it for
        dubious gain. This happens to be one of the few that I’ve finished, so, hope you enjoy. ❤️
      </p>
    </Layout>
  );
}
